import {ICalendarCommonProps} from '@sberbusiness/triplex/desktop/components/Calendar/Calendar';
import {ICalendarProvideProps, TPickedRange, TPickedRangeProp} from '@sberbusiness/triplex/desktop/components/Calendar/types';
