...
import {AccordionFormItem, IAccordionItemProps} from '@sberbusiness/triplex/desktop/components/AccordionForm/AccordionFormItem';
import {classnames} from '@sberbusiness/triplex/common/utils/classnames/classnames';
import {glueFunctions} from '@sberbusiness/triplex/common/utils/glueFunctions';
 ...
 *
 * @prop {Function} [onToggle] Обработчик открытия/закрытия вкладки.
 * @prop {Function} [onRemove] Обработчик удаления вкладки.
 */
