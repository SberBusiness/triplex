import {KeyDownListener} from '@sberbusiness/triplex/desktop/components/KeyDownListener/KeyDownListener';
import {ISmallInputProps, SmallInput} from '@sberbusiness/triplex/desktop/components/SmallInput/SmallInput';
