import {Hoverable} from '@sberbusiness/triplex/desktop/components/Hoverable/Hoverable';
import {TooltipBase} from '@sberbusiness/triplex/desktop/components/Tooltip/components/TooltipBase';
...
export class Tooltip extends React.Component<ITooltipProps, IState> {
    ...
    public componentDidMount(): void {
        ...
        if (this.props.toggleType === 'click' && this.props.isOpen) {
