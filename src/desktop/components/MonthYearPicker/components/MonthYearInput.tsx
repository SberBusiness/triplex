...
import {defaultMonthYearPlaceholder} from '@sberbusiness/triplex/desktop/components/MonthYearPicker/const';
import {IInputProps} from '@sberbusiness/triplex/desktop/components/Input/Input';
