...
import {TableBasicRow} from '@sberbusiness/triplex/desktop/components/Tables/TableBasic/components/TableBasicRow';
import {ITableBasicColumn, ITableBasicRow} from '@sberbusiness/triplex/desktop/components/Tables/TableBasic/types';
