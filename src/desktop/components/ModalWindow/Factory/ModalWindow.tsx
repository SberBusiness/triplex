...
import {overlayDataAttributeIsOpen} from '@sberbusiness/triplex/desktop/components/ModalWindow/components/ModalWindowTopOverlay';
import {Portal} from '@sberbusiness/triplex/desktop/components/Portal/Portal';
import {isEmptyObject} from '@sberbusiness/triplex/desktop/utils/isEmptyObject';
...
/** Класс, который блюрит(blur) фоновый контент. */
