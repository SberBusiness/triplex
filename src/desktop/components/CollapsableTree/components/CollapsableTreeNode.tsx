...
import {ITreeViewNodeProps, ITreeViewNodeProvideProps} from '@sberbusiness/triplex/desktop/components/TreeView/components/TreeViewNode';
import {
    IAccordionBaseProps,
    IAccordionBodyProvideProps,
    IAccordionHeaderProvideProps,
} from '@sberbusiness/triplex/desktop/components/AccordionBase/types';
import {TreeView} from '@sberbusiness/triplex/desktop/components/TreeView/TreeView';
