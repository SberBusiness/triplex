import {ReactHeight} from '@sbbol/web-library/common/components/ReactHeight/ReactHeight';
import {classnames} from '@sbbol/web-library/common/utils/classnames/classnames';
import {TopOverlayClose} from '@sbbol/web-library/desktop/components/TopOverlay/components/TopOverlayClose';
import {TopOverlayContent} from '@sbbol/web-library/desktop/components/TopOverlay/components/TopOverlayContent';
import {TopOverlayControls} from '@sbbol/web-library/desktop/components/TopOverlay/components/TopOverlayControls';
        ...
        return (
            ...
            >
                <ReactHeight onHeightReady={this.setOverlayHeight}>
                    <div className="cssClass[topOverlayInner]">{children}</div>
                </ReactHeight>
            </div>
        );
    }
