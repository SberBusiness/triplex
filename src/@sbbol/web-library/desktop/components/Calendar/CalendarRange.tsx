import {ICalendarCommonProps} from '@sbbol/web-library/desktop/components/Calendar/Calendar';
import {ICalendarProvideProps, TPickedRange, TPickedRangeProp} from '@sbbol/web-library/desktop/components/Calendar/types';
