import {dateFormatYYYYMMDD, globalLimitRange, YEARS_SET} from '@sbbol/web-library/desktop/common/consts/DateConst';
import {ECalendarMomentPeriodType, ECalendarTab} from '@sbbol/web-library/desktop/common/enums/EDatePeriod';
...
import {
    ...
    TPickedRange,
    TPickedRangeProp,
} from '@sbbol/web-library/desktop/components/Calendar/types';
import {IDateLimitRange} from '@sbbol/web-library/desktop/common/types/DateTypes';
import {CalendarControls} from '@sbbol/web-library/desktop/components/Calendar/components/CalendarControls';
import {Decade} from '@sbbol/web-library/desktop/components/Calendar/components/Decade';
import {Month} from '@sbbol/web-library/desktop/components/Calendar/components/Month';
import {Year} from '@sbbol/web-library/desktop/components/Calendar/components/Year';
import {EChangePageDirection, EPickType} from '@sbbol/web-library/desktop/components/Calendar/enums';
import {CalendarRange} from '@sbbol/web-library/desktop/components/Calendar/CalendarRange';
import {EVENT_KEYS} from '@sbbol/web-library/desktop/utils/keyboard';
import moment, {Moment} from 'moment';
import * as React from 'react';
import {formatDate, getHeader, isCalendarRange, parsePickedDate} from '@sbbol/web-library/desktop/components/Calendar/utils';
...
export class Calendar extends React.PureComponent<TCalendarProps, IState> {
    ...
    public componentDidUpdate(prevProps: TCalendarProps, prevState: IState): void {
        ...
        const prevPickedDate = isCalendarRange(prevProps)
            ? parsePickedDate(prevProps.defaultDate, format!)
