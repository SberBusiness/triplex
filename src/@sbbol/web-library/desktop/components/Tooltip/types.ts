...
import {TOrderedChildren} from '@sbbol/web-library/desktop/utils/reactChildDeprecated';
 ...
 */
export interface ITooltipProps extends Omit<ITooltipBaseProps, 'setTooltipRef' | 'closeTooltip' | 'modalFocusManager'> {
    toggleType?: 'click' | 'hover';
