...
import {NotificationBodyContent} from '@sbbol/web-library/desktop/components/Notification/components/NotificationBodyContent';
import {NotificationFooter} from '@sbbol/web-library/desktop/components/Notification/components/NotificationFooter';
import {NotificationHeader} from '@sbbol/web-library/desktop/components/Notification/components/NotificationHeader';
