 ...
 */
export type TTreeViewContextRegisterNode = (node: TreeViewAbstractNode, parentNode: TreeViewAbstractNode) => void;
...
// Начальное значение контекста. Здесь нужно только для типизации и будет заполнено в @sbbol/web-library/desktop/components/TreeView/TreeView.tsx.
