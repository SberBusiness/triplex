...
export const Calendar_Tokens: TDesignTokensComponentsCalendarValues = {
    Background: [{ref: 'Basic.100'}, {ref: 'Basic.700'}], // var(--triplex-Calendar-Background)
    ...
    View_Item_Background_Hover: [{ref: 'Neutral.100'}, {ref: 'Basic.500'}], // var(--triplex-Calendar-View_Item_Background_Hover)
    ...
    View_Item_Background_Range: [{ref: 'Neutral.100'}, {ref: 'Basic.500'}], // var(--triplex-Calendar-View_Item_Background_Range)
    ...
    View_Item_Mark_Background: [{ref: 'Neutral.700'}, {ref: 'Neutral.900'}], // var(--triplex-Calendar-View_Item_Mark_Background)
};
