...
export const AlertProcess_Tokens: TDesignTokensComponentsAlertProcessValues = {
    ...
    System_Background: [{ref: 'Neutral.100'}, {ref: 'Basic.0'}], // var(--triplex-AlertProcess-System_Background)
    System_Border_Color: [{ref: 'Neutral.700'}, {ref: 'Neutral.700'}], // var(--triplex-AlertProcess-System_Border_Color)
