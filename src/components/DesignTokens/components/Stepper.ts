...
export const Stepper_Tokens: TDesignTokensComponentsStepperValues = {
    ...
    Step_BorderColor_Disabled: [{ref: 'Neutral.500'}, {ref: 'Basic.300'}], // var(--triplex-Stepper-Step_BorderColor_Disabled)
    ButtonPrev_Background: [
    ...
    Wrapper_Background: [{value: 'linear-gradient(#FFFFFF 64px, transparent)'}, {ref: 'Basic.900'}], // var(--triplex-Stepper-Wrapper_Background)
    Wrapper_BoxShadow: [{value: '0 10px 15px 0 #E4E8EB'}, {value: 'none'}], // var(--triplex-Stepper-Wrapper_BoxShadow)
};
