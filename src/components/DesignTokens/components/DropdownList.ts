...
export const DropdownList_Tokens: TDesignTokensComponentsDropdownListValues = {
    Background_Active: [{ref: 'Neutral.100'}, {ref: 'Basic.300'}], // var(--triplex-DropdownList-Background_Active)
    Background_Default: [{value: 'none'}, {value: 'none'}], // var(--triplex-DropdownList-Background_Default)
    Background_Selected: [{ref: 'Neutral.500'}, {ref: 'Neutral.900'}], // var(--triplex-DropdownList-Background_Selected)
