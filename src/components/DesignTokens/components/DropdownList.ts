...
export const designTokensComponentsDropdownListKeys = ['Background_Default', 'Background_Active', 'Background_Selected', 'Color'] as const;
...
export const DropdownList_Tokens: TDesignTokensComponentsDropdownListValues = {
    ...
    Background_Active: [{ref: 'Neutral.100'}, {ref: 'Basic.500'}], // var(--triplex-DropdownList-Background_Active)
