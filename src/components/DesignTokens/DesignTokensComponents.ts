...
import {
    ...
    TDesignTokensComponentsTableBasicSettingsValue,
...
export const DesignTokensComponents: TDesignTokensComponents = {
    ...
    Chip: GetTokensValueByTheme<TDesignTokensComponentsChipValue>(ETriplexTheme.LIGHT, Chip_Tokens),
    ...
    ListItem: GetTokensValueByTheme<TDesignTokensComponentsListItemValue>(ETriplexTheme.LIGHT, ListItem_Tokens),
    ListItemControlsButton: GetTokensValueByTheme<TDesignTokensComponentsListItemControlsButtonValue>(
        ETriplexTheme.LIGHT,
        ListItemControlsButton_Tokens
    ),
    ListMaster: GetTokensValueByTheme<TDesignTokensComponentsListMasterValue>(ETriplexTheme.LIGHT, ListMaster_Tokens),
    ...
    Step: GetTokensValueByTheme<TDesignTokensComponentsStepValue>(ETriplexTheme.LIGHT, Step_Tokens),
    ...
    TableBasicSettings: GetTokensValueByTheme<TDesignTokensComponentsTableBasicSettingsValue>(
        ETriplexTheme.LIGHT,
        TableBasicSettings_Tokens
    ),
    ...
    TabsLine: GetTokensValueByTheme<TDesignTokensComponentsTabsLineValue>(ETriplexTheme.LIGHT, TabsLine_Tokens),
