...
/** Модальное окно. */
export class ModalWindow extends React.PureComponent<IModalWindowProps> {
    public static displayName = 'ModalWindow';
    ...
    private renderModalWindow = () => {
        const {className, containerClassName, focusTrapProps, isLoading, isOpen, children, onExited, closeButton, size, ...props} =
            this.props;
