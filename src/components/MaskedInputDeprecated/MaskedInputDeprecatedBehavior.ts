import {DEFAULT_FORMAT_CHARACTERS, DEFAULT_PLACEHOLDER_CHAR} from '@sberbusiness/triplex/components/MaskedInputDeprecated/consts';
import {IInputMaskDeprecatedCoreConfig, TFormatCharacters} from '@sberbusiness/triplex/components/MaskedInputDeprecated/types';
