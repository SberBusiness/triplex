...
import {CardAction} from '@sbbol/web-library/desktop/components/Card/CardAction';
...
<>
    ...
    <ComponentPreview>
        <CardAction roundingSize={roundingSize} selected={selected} toggle={setSelected} style={{width: '126px'}}>
