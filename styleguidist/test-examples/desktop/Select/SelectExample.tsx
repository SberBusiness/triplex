...
import {Select, ISelectOption, ESelectOrientation} from '@sbbol/web-library/desktop/components/Select/Select';
...
export const SelectExample: React.FC<ISelectExampleProps> = ({topOrientation, inputValue, ...selectProps}) => {
