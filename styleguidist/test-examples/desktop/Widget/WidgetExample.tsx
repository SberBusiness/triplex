...
import {Widget} from '@sbbol/web-library/desktop/components/Widget/Widget';
import {
    IWidgetHeaderProvideProps,
    IWidgetFooterProvideProps,
    IWidgetBodyProvideProps,
} from '@sbbol/web-library/desktop/components/Widget/types';
...
import {EWidgetHeaderControlsAlign} from '@sbbol/web-library/desktop/components/Widget/components/WidgetHeader/WidgetHeader';
