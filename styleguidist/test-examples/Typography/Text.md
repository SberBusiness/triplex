...
<>
    ...
    <ComponentPreview style={{display: 'flex', flexDirection: 'column'}}>
        <Text size={ETextSize.B1} type={type} weight={weight} line={line} underline={underline}
              strikethrough={strikethrough}>
            B1 Sample Text
        </Text>
        <Text size={ETextSize.B2} type={type} weight={weight} line={line} underline={underline}
              strikethrough={strikethrough}>
            B2 Sample Text
        </Text>
        <Text size={ETextSize.B3} type={type} weight={weight} line={line} underline={underline}
              strikethrough={strikethrough}>
            B3 Sample Text
        </Text>
    </ComponentPreview>
