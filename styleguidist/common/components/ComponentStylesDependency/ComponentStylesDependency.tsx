    ...
    const renderBody = () => {
        ...
        return (
            <div className="content">
                Для корректного отображения компонента подключите общий файл стилей @sbbol/web-library:
                <Pathline>@sbbol/web-library/styles/{isMobileComponent ? 'mobile' : 'desktop'}/styles.css</Pathline>
                {paths.length ? (
                    <>
                        Или следующие файлы:
                        {paths.map((path) => (
