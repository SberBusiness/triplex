...
module.exports = {
    ...
    resolve: {
        alias: {
            '@sbbol/web-library/styles': path.resolve(__dirname, '../../out/@sbbol/web-library/styles'),
            '@sbbol/web-library': path.resolve(__dirname, '../../src/@sbbol/web-library'),
            '@styles': path.resolve(__dirname, '../../out/@sbbol/web-library/styles'),
