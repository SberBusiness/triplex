...
<CardAction onToggle={setSelected} style={{width: '232px'}}>
    <CardAction.Media
        style={{backgroundImage: 'url(styleguidist/public/evotor.png)', height: '129px'}}
    />
    <CardAction.Content>
...
<CardAction roundingSize={ECardRoundingSize.SM} onToggle={setSelected} style={{width: '232px'}}>
    <CardAction.Media
        style={{backgroundImage: 'url(styleguidist/public/evotor.png)', height: '129px'}}
    />
    <CardAction.Content>
