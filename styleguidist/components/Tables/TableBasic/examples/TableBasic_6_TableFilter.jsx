...
const filters = [
    ...
    },
    {
        ...
        label: 'Черновики',
        'aria-label': 'Черновик',
        'data-test-id': 'TestTable__MasterTable.TableFilter__Draft',
    },
    {
        id: 'table-filter-sign',
        label: 'На подпись и отправку',
        'aria-label': 'На подпись и отправку',
        'data-test-id': 'TestTable__MasterTable.TableFilter__Sign',
    },
    {
    ...
    <MasterTable.TableFilterPanel>
        <MasterTable.TableFilter
            ...
            dropdownTargetHtmlAttributes={{
                'data-test-id': 'MasterTable.TableFilter__DropdownTarget',
