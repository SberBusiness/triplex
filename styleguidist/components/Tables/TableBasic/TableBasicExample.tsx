...
import {ISelectOption, Select} from '@sberbusiness/triplex/components/Select/Select';
    ...
    const renderControlPanel = () => (
        <ComponentControlPanel>
            <ComponentControlPanel.Checkbox
                ...
                setChecked={(checked) => {
                    setControlPanelState({...controlPanelState, isLoading: checked});
                    setCheckedState([]);
                }}
            >
                Состояние загрузки
            ...
            <ComponentControlPanel.Checkbox
                ...
                setChecked={(checked) => {
                    setControlPanelState({...controlPanelState, hasData: checked});
                    setCheckedState([]);
                }}
            >
                С примером данных
            ...
            <ComponentControlPanel.Checkbox
                ...
                setChecked={(checked) => {
                    setControlPanelState({...controlPanelState, hasTableFilter: checked});
                    setCheckedState([]);
                }}
            >
                С панелью табличных фильтров
            </ComponentControlPanel.Checkbox>
            <ComponentControlPanel.Checkbox
                checked={controlPanelState.hasQuickFilterPanel}
                setChecked={(checked) => {
                    setControlPanelState({...controlPanelState, hasQuickFilterPanel: checked});
                    setCheckedState([]);
                }}
            >
                С панелью быстрых фильтров
            </ComponentControlPanel.Checkbox>
        </ComponentControlPanel>
    );
