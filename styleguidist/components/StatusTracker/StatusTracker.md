```jsx
import {StatusTracker} from '@sberbusiness/triplex/components/StatusTracker/StatusTracker';
import {Title} from '@sberbusiness/triplex/components/Typography/Title';
import {Text} from '@sberbusiness/triplex/components/Typography/Text';
import {ETextSize, ETitleSize, EFontType, ELineType} from '@sberbusiness/triplex/components/Typography/enums';
...
const renderButton = () => (
    <Button onClick={() => setShowSMSInput(true)} theme={EButtonTheme.GENERAL} size={EButtonSize.MD} block>
        Подписать СМС-кодом
    </Button>
);
...
const renderSMSInput = () => (
    <SMSInput size={ESMSInputSize.MD} code={code} onChangeCode={setCode} onSubmitCode={() => setCode('')}>
        ...
        <SMSInput.Input placeholder="Введите код" autoFocus />
