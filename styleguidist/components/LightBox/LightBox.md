...
const renderControlPanel = () => (
    <ComponentControlPanel>
        <ComponentControlPanel.Checkbox checked={fixedHeader} setChecked={setFixedHeader}>
            Фиксированный хедер
        </ComponentControlPanel.Checkbox>
        <ComponentControlPanel.Checkbox checked={fixedFooter} setChecked={setFixedFooter}>
            Фиксированный футер
        </ComponentControlPanel.Checkbox>
        <ComponentControlPanel.Checkbox checked={arrows} setChecked={setArrows}>
            Со стрелками
        </ComponentControlPanel.Checkbox>
    </ComponentControlPanel>
);
            ...
            {arrows && (
                <>
                    <LightBox.Controls.Next
                        title="Вперёд"
                        clickByArrowRight
                        onClick={() => console.log('Arrow next!')}
                    />
                    <LightBox.Controls.Prev
                        title="Назад"
                        clickByArrowLeft
                        onClick={() => console.log('Arrow prev!')}
                    />
                </>
            )}
