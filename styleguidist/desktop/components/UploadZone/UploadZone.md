...
```jsx
import {UploadZone} from '@sberbusiness/triplex/desktop/components/UploadZone/UploadZone';
...
import {EVerticalAlign} from '@sberbusiness/triplex/desktop/components/Tables/TableBasic/enums';
...
import {PlugSrvIcon32} from '@sberbusiness/icons/PlugSrvIcon32';
import {TableBasic} from '@sberbusiness/triplex/desktop/components/Tables/TableBasic/TableBasic';
import {ECellType, EVerticalAlign} from '@sberbusiness/triplex/desktop/components/Tables/TableBasic/enums';
    ...
    return data.map((d, i) => {
        ...
        return {
            ...
            rowData: {
                ...
                download: (
                    <Button theme={EButtonTheme.SECONDARY} size={EButtonSize.SM} block={true}>
