...
import {EHorizontalAlign} from '@sbbol/web-library/desktop/components/Tables/TableBasic/enums';
...
const columns = [
    {fieldKey: 'number', label: '№', width: 65},
    {
...
const actions = [
    {id: 1, label: 'действие 1', action: () => alert('действие 1')},
    {id: 2, label: 'действие 2', action: () => alert('действие 2')},
    {id: 3, label: 'действие 3', action: () => alert('действие 3')},
];
...
const renderActions2 = <ButtonDropdown theme={EButtonTheme.DOTS} onClick={handlePrevent} size={EButtonSize.MD} options={actions} />;
