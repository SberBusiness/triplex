...
import {Title} from '@sbbol/web-library/desktop/components/Typography/Title';
import {EFontType, EFontWeight, ELineType, ETextSize, ETitleSize} from '@sbbol/web-library/desktop/components/Typography/enums';
