...
import {AccordionForm} from '@sbbol/web-library/desktop/components/AccordionForm/AccordionForm';
                ...
                <Row>
                    <Col>
                        <Field alignLabel>
                            <Col size={3}>
                                <Label>
                                    <Label.Text>Текст в 1 строку</Label.Text>
                ...
                <Row>
                    <Col>
                        <Field alignLabel>
                            ...
                            <Col size={8}>
                                <Select value={selectValue} onChange={setSelectValue} options={selectOptions}/>
                            </Col>
                        </Field>
                    </Col>
                </Row>
