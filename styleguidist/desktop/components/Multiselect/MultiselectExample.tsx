...
import {Multiselect} from '@sbbol/web-library/desktop/components/Multiselect/Multiselect';
...
import {ISelectExtendedTargetProvideProps} from '@sbbol/web-library/desktop/components/Select/SelectExtended';
import {IMultiselectDropdownProvideProps} from '@sbbol/web-library/desktop/components/Multiselect/components/MultiselectDropdown';
import {SpinnerWidget} from '@sbbol/web-library/desktop/components/SpinnerWidget/SpinnerWidget';
import {CheckboxTreeExtended} from '@sbbol/web-library/desktop/components/CheckboxTreeExtended/CheckboxTreeExtended';
...
export class MultiselectExample extends React.PureComponent<ISelectExtendedExampleProps, IMultiselectExampleState> {
    ...
    renderTarget = (props: ISelectExtendedTargetProvideProps): JSX.Element => {
        ...
        return (
            <Multiselect.Target label={this.renderTags()} disabled={disabled} error={error} placeholder="Выберите значение" {...props} />
        );
    };
    ...
    renderDropdown = (dropdownProps: IMultiselectDropdownProvideProps): React.ReactNode => {
        const {loading, hasSearchInput, topOrientation} = this.props;
        ...
        return (
            <Multiselect.Dropdown {...dropdownProps} topOrientation={topOrientation} data-test-id="Example_Multiselect.Dropdown">
                {hasSearchInput && (
                    <Multiselect.Dropdown.Header>
                        <Input setInputRef={this.setInputFilterNode} value={filter} onChange={this.handleFilterChange} />
                    </Multiselect.Dropdown.Header>
                )}
